...
public class EmployeeController {
    ...
    public List<MonthlySalesData> getSalesById(@PathVariable int id) throws SQLException {
    ...
    public List<MonthlySalesData> getSalesByEmployeeInMonth(@PathVariable String str) throws SQLException {
